        ...
        if (
            ...
            if (
                    ...
                    and (
                        ...
                        or stage1_comparator_result.evaluation_count != 34_264
                    )
            ):
                raise RuntimeError(
                    "Stage-1 COINN-GA did not satisfy the 600-generation "
                    "full-run contract and 34,264-inference full-run contract"
                )
