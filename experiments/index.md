...
_Auto-generated from `/hy-tmp/Reinforcement-For-Robustness/experiments/registry.jsonl` on 2026-05-19T20:42:28+08:00. Edit `notes` field in registry.jsonl to annotate a run; rerun `python3 tools/experiments_log.py rebuild` to refresh._

- Total registered run_ids: **3**
- By status: complete=3
- By dataset: mrpc=3
