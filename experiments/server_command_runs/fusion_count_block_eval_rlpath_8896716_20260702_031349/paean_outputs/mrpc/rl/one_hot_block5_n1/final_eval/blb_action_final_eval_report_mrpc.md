...
- json: `/hy-tmp/fusion_block_eval_rlpath_8896716_20260702_030732/src/experiments/server_command_runs/fusion_count_block_eval_rlpath_8896716_20260702_031349/paean_outputs/mrpc/rl/one_hot_block5_n1/final_eval/blb_action_final_eval_results_mrpc.json`
...
- target total_bits_sum: `10955`
- target total_fusion_count: `10`
...
- selected (`ActionSelected`): loss=0.383628 ± 0.000900, Acc.=0.877451 ± 0.001550, F1=0.875937 ± 0.001574, total_bits=10955, fusion=10, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.383628 | 0.000900 | 0.877451 | 0.001550 | 0.875937 | 0.001574 | 118.926 | 10955 | 10 | True | True |
...
- replan application summary: `{'applied_before_forward': True, 'model_uses_replan_config': True, 'expected_config_count': 47, 'applied_config_count': 47, 'invalid_config_count': 0, 'missing_compact_config_count': 0, 'missing_decoded_cfg_count': 0, 'apply_error_count': 0, 'override_total': 10}`
- fusion group diagnostics: `{'group_name': 'one_hot_block5_n1', 'declared_total_fusion_count': 10, 'realized_total_fusion_count': 10, 'declared_by_graph': {'block1_mrpc': 0, 'block2_mrpc': 0, 'block4': 0, 'block5_n0': 0, 'block5_n1': 10, 'block5_n2': 0, 'block5_n4': 0}, 'matches_realized_total': True}`
