...
- json: `/hy-tmp/fusion_block_eval_rlpath_8896716_20260702_030732/src/experiments/server_command_runs/fusion_count_block_eval_rlpath_8896716_20260702_031349/paean_outputs/mrpc/rl/one_hot_block2_mrpc/final_eval/blb_action_final_eval_results_mrpc.json`
...
- target total_bits_sum: `11009`
- target total_fusion_count: `12`
...
- selected (`ActionSelected`): loss=0.382447 ± 0.001315, Acc.=0.878431 ± 0.001201, F1=0.876868 ± 0.001247, total_bits=11009, fusion=12, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.382447 | 0.001315 | 0.878431 | 0.001201 | 0.876868 | 0.001247 | 119.093 | 11009 | 12 | True | True |
...
- replan application summary: `{'applied_before_forward': True, 'model_uses_replan_config': True, 'expected_config_count': 47, 'applied_config_count': 47, 'invalid_config_count': 0, 'missing_compact_config_count': 0, 'missing_decoded_cfg_count': 0, 'apply_error_count': 0, 'override_total': 12}`
- fusion group diagnostics: `{'group_name': 'one_hot_block2_mrpc', 'declared_total_fusion_count': 12, 'realized_total_fusion_count': 12, 'declared_by_graph': {'block1_mrpc': 0, 'block2_mrpc': 12, 'block4': 0, 'block5_n0': 0, 'block5_n1': 0, 'block5_n2': 0, 'block5_n4': 0}, 'matches_realized_total': True}`
