...
- json: `/hy-tmp/fusion_block_eval_rlpath_8896716_20260702_030732/src/experiments/server_command_runs/fusion_count_block_eval_rlpath_8896716_20260702_031349/paean_outputs/mrpc/rl/block2_block5_all_layers_fusionmax/final_eval/blb_action_final_eval_results_mrpc.json`
...
- target total_bits_sum: `10671`
- target total_fusion_count: `24`
...
- selected (`ActionSelected`): loss=0.384409 ± 0.000730, Acc.=0.875490 ± 0.002858, F1=0.873763 ± 0.002901, total_bits=10671, fusion=24, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.384409 | 0.000730 | 0.875490 | 0.002858 | 0.873763 | 0.002901 | 118.827 | 10671 | 24 | True | True |
...
- replan application summary: `{'applied_before_forward': True, 'model_uses_replan_config': True, 'expected_config_count': 47, 'applied_config_count': 47, 'invalid_config_count': 0, 'missing_compact_config_count': 0, 'missing_decoded_cfg_count': 0, 'apply_error_count': 0, 'override_total': 24}`
- fusion group diagnostics: `{'group_name': 'block2_block5_all_layers_fusionmax', 'declared_total_fusion_count': 26, 'realized_total_fusion_count': 24, 'declared_by_graph': {'block1_mrpc': 0, 'block2_mrpc': 12, 'block4': 0, 'block5_n0': 1, 'block5_n1': 10, 'block5_n2': 2, 'block5_n4': 1}, 'matches_realized_total': False}`
