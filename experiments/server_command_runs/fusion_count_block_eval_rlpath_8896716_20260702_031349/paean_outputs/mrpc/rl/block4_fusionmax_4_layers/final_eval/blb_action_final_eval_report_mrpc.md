...
- json: `/hy-tmp/fusion_block_eval_rlpath_8896716_20260702_030732/src/experiments/server_command_runs/fusion_count_block_eval_rlpath_8896716_20260702_031349/paean_outputs/mrpc/rl/block4_fusionmax_4_layers/final_eval/blb_action_final_eval_results_mrpc.json`
...
- selected (`ActionSelected`): loss=0.385305 ± 0.002242, Acc.=0.876471 ± 0.001961, F1=0.875006 ± 0.001956, total_bits=11189, fusion=4, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.385305 | 0.002242 | 0.876471 | 0.001961 | 0.875006 | 0.001956 | 118.706 | 11189 | 4 | True | True |
...
- replan application summary: `{'applied_before_forward': True, 'model_uses_replan_config': True, 'expected_config_count': 47, 'applied_config_count': 47, 'invalid_config_count': 0, 'missing_compact_config_count': 0, 'missing_decoded_cfg_count': 0, 'apply_error_count': 0, 'override_total': 4}`
- fusion group diagnostics: `{'group_name': 'block4_fusionmax_4_layers', 'declared_total_fusion_count': 1, 'realized_total_fusion_count': 4, 'declared_by_graph': {'block1_mrpc': 0, 'block2_mrpc': 0, 'block4': 0, 'block5_n0': 0, 'block5_n1': 0, 'block5_n2': 0, 'block5_n4': 0, 'block4_selected_layers': 1}, 'matches_realized_total': False}`
