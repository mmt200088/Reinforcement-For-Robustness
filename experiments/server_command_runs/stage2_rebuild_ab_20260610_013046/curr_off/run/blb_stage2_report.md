...
- Profile（数据集）: `mrpc`
- 生成时间: 2026-06-10T05:33:59.042152
- 训练时长: 6671.5 秒（约 111.2 分钟）
- Episode 进度: 6000 / 6000
- 模数链 invoker: `in_process_real`

## 1. Reward 概览

- 最优 reward (best): **+40.130119**
- 全程 episode reward 均值: +35.0870
- 全程 episode reward 最大值: +40.1552
- 全程 episode reward 最小值: -3.2110
- 全程 episode reward 标准差: 9.9421
...
|------|------|
| `terminal_priority` | 3 |
| `terminal_reward` | 42.41530919045055 |
| `terminal_cost_score` | 2.2972536348949917 |
| `terminal_cost_rank_score` | 3160.0 |
| `terminal_cost_rank_fusion` | 0.0 |
| `terminal_cost_rank_truncation` | 0.0 |
| `terminal_cost_rank_bits` | 0.0 |
| `terminal_p3_metric_margin_reward` | 0.11805555555555693 |
...
| `terminal_fusion_gain` | 15.0 |
| `terminal_k_gain` | 2.1694915254237284 |
| `terminal_bits_gain` | 448.0 |
| `terminal_metric1_mean` | 0.8625 |
| `terminal_metric2_mean` | 0.8625 |
...
| L00 | B4 | F.softmax_out_fresh=35, F.v_fresh=25, M.softmax_out_mask=14, M.v_mask=14, M.softmax_v_mask=14, S.ln_mean_inv_d=20, S.ln_var_inv_d=20, W.wo=22, R.softmax_v_matmul_r=31, R.ln_mean_r=31, R.ln_var_r=off, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=31, K=**8** |
| L00 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=21, M.gamma=16, W.wffn1=16, M.gelu_coeff=16, R.normalize_r=28, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**10** |
| L01 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=30, R.var_r=27, R.wffn2_r=off, R.square_r=off, K=**10** |
...
| L01 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=25, M.gamma=20, W.wffn1=20, M.gelu_coeff=20, R.normalize_r=31, R.gamma_r=off, R.wffn1_r=31, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**9** |
...
| L02 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=31, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=28, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**12** |
...
| L03 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=31, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=28, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**11** |
...
| L04 | B4 | F.softmax_out_fresh=35, F.v_fresh=25, M.softmax_out_mask=14, M.v_mask=14, M.softmax_v_mask=14, S.ln_mean_inv_d=20, S.ln_var_inv_d=20, W.wo=22, R.softmax_v_matmul_r=31, R.ln_mean_r=31, R.ln_var_r=off, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=31, K=**8** |
| L04 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=31, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=28, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**10** |
| L05 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=30, R.var_r=27, R.wffn2_r=off, R.square_r=off, K=**8** |
| L05 | B2 | F.inv_std_fresh=20, F.x_centered_fresh=28, M.gamma=16, W.wk=16, W.wv=22, M.kt_mask1=15, M.kt_mask2=15, M.qkt_merge_mask=15, R.gamma_r=28, R.kt_mask2_r=off, R.qkt_merge_mask_r=off, W.wq=22, M.q_mask1=15, M.q_mask2=15, R.normalize_r=off, R.wk_r=off, R.wq_r=off, R.wv_r=off, R.kt_mask1_r=28, R.q_mask1_r=28, R.q_mask2_r=off, R.qkt_matmul_r=28, K=**8** |
...
| L05 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=31, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=28, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**10** |
| L06 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=30, R.var_r=27, R.wffn2_r=off, R.square_r=off, K=**10** |
...
| L06 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=31, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=28, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**11** |
...
| L07 | B4 | F.softmax_out_fresh=35, F.v_fresh=25, M.softmax_out_mask=14, M.v_mask=14, M.softmax_v_mask=14, S.ln_mean_inv_d=20, S.ln_var_inv_d=20, W.wo=22, R.softmax_v_matmul_r=31, R.ln_mean_r=31, R.ln_var_r=off, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=31, K=**11** |
| L07 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=21, M.gamma=16, W.wffn1=16, M.gelu_coeff=16, R.normalize_r=28, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**13** |
...
| L08 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=31, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=31, R.gamma_r=off, R.wffn1_r=31, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**13** |
...
| L10 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=30, R.var_r=27, R.wffn2_r=off, R.square_r=off, K=**11** |
...
| L10 | B4 | F.softmax_out_fresh=21, F.v_fresh=17, M.softmax_out_mask=10, M.v_mask=14, M.softmax_v_mask=10, S.ln_mean_inv_d=12, S.ln_var_inv_d=20, W.wo=11, R.softmax_v_matmul_r=31, R.ln_mean_r=31, R.ln_var_r=off, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=31, K=**13** |
| L10 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=31, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=28, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**8** |
| L11 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=30, R.var_r=27, R.wffn2_r=off, R.square_r=off, K=**10** |
...
| L11 | B4 | F.softmax_out_fresh=21, F.v_fresh=17, M.softmax_out_mask=10, M.v_mask=14, M.softmax_v_mask=10, S.ln_mean_inv_d=12, S.ln_var_inv_d=20, W.wo=11, R.softmax_v_matmul_r=31, R.ln_mean_r=31, R.ln_var_r=off, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=31, K=**9** |
| L11 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=31, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=28, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**8** |
| (legacy) first_input | – | `scaling_factor=30` |

### 5.2 Best vs baseline · 哪些槽位变了

_共 151 个槽位发生变化（112 个 SF + 39 个 K bits）_
...
```
9, 9, 9, 9, 9, 9, 9, 9, 3, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 5, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 9, 4, 7, 6, 7, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 4, 9, 9, 9, 9, 9, 9, 0, 0, 4, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 2, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 1, 9, 6, 9, 8, 9, 9, 0, 9, 0, 0, 0, 9, 0, 0, 0, 1, 9, 9, 9, 9, 9, 9, 0, 0, 4, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 1, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 1, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 5, 9, 9, 9, 9, 9, 9, 0, 0, 2, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 1, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 5, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 2, 9, 9, 9, 9, 9, 9, 0, 0, 1, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 1, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 4, 9, 9, 9, 9, 9, 9, 0, 0, 0, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 0, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 1, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 4, 9, 9, 9, 9, 9, 9, 0, 0, 4, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 4, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 1, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 2, 9, 9, 9, 9, 9, 9, 0, 0, 5, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 5, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 2, 9, 4, 7, 6, 7, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 3, 9, 9, 9, 9, 9, 9, 0, 0, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 0, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 3, 9, 9, 9, 9, 9, 9, 0, 9, 0, 0, 0, 9, 0, 0, 0, 3, 9, 9, 9, 9, 9, 9, 0, 0, 3, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 3, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 3, 9, 9, 9, 9, 9, 9, 0, 0, 2, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 0, 9, 9, 9, 9, 9, 9, 9, 3, 0, 5, 0, 9, 0, 5, 9, 3, 9, 9, 0, 0, 0, 0, 0, 9, 3, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 0, 9, 9, 9, 9, 9, 9, 0, 0, 4, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 2, 9, 9, 9, 9, 9, 9, 9, 3, 0, 5, 0, 9, 0, 5, 9, 3, 9, 9, 0, 0, 0, 0, 0, 9, 1, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 0, 4
```
