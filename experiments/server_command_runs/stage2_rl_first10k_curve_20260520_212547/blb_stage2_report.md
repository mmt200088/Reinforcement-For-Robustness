...
- Profile（数据集）: `mrpc`
- 生成时间: 2026-05-21T02:34:13.828149
- 训练时长: 18384.5 秒（约 306.4 分钟）
- Episode 进度: 10000 / 10000
- 模数链 invoker: `in_process_real`

## 1. Reward 概览

- 最优 reward (best): **+38.378601**
- 全程 episode reward 均值: +37.7683
- 全程 episode reward 最大值: +38.3786
- 全程 episode reward 最小值: +37.0949
- 全程 episode reward 标准差: 0.1398
...
| L01 | B2 | F.inv_std_fresh=31, F.x_centered_fresh=30, M.gamma=20, W.wk=22, W.wv=22, M.kt_mask1=15, M.kt_mask2=15, M.qkt_merge_mask=15, R.gamma_r=31, R.kt_mask2_r=31, R.qkt_merge_mask_r=28, W.wq=22, M.q_mask1=22, M.q_mask2=22, R.normalize_r=off, R.wk_r=off, R.wq_r=off, R.wv_r=off, R.kt_mask1_r=off, R.q_mask1_r=off, R.q_mask2_r=off, R.qkt_matmul_r=off, K=**13** |
...
| L02 | B2 | F.inv_std_fresh=31, F.x_centered_fresh=30, M.gamma=20, W.wk=22, W.wv=22, M.kt_mask1=13, M.kt_mask2=15, M.qkt_merge_mask=15, R.gamma_r=31, R.kt_mask2_r=31, R.qkt_merge_mask_r=28, W.wq=22, M.q_mask1=22, M.q_mask2=22, R.normalize_r=off, R.wk_r=off, R.wq_r=off, R.wv_r=off, R.kt_mask1_r=off, R.q_mask1_r=off, R.q_mask2_r=off, R.qkt_matmul_r=off, K=**13** |
...
| L03 | B3 | F.x_fresh=28, S.inv_2n=15, R.sq0=31, R.sq1=31, R.sq2=31, R.sq3=31, R.x_inv_2n_r=off, K=**13** |
...
| L04 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=34, R.var_r=34, R.wffn2_r=off, R.square_r=off, K=**12** |
...
| L04 | B3 | F.x_fresh=28, S.inv_2n=15, R.sq0=31, R.sq1=31, R.sq2=31, R.sq3=31, R.x_inv_2n_r=off, K=**13** |
...
| L05 | B4 | F.softmax_out_fresh=35, F.v_fresh=30, M.softmax_out_mask=14, M.v_mask=14, M.softmax_v_mask=14, S.ln_mean_inv_d=20, S.ln_var_inv_d=20, W.wo=22, R.softmax_v_matmul_r=31, R.ln_mean_r=31, R.ln_var_r=28, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=off, K=**13** |
...
| L06 | B5 | F.inv_std_fresh=30, F.x_centered_fresh=30, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=off, R.gamma_r=30, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=off, R.gc1=off, R.gc2=off, R.gc3=off, K=**13** |
| L07 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=34, R.var_r=34, R.wffn2_r=off, R.square_r=off, K=**13** |
| L07 | B2 | F.inv_std_fresh=31, F.x_centered_fresh=30, M.gamma=20, W.wk=22, W.wv=22, M.kt_mask1=15, M.kt_mask2=15, M.qkt_merge_mask=15, R.gamma_r=31, R.kt_mask2_r=31, R.qkt_merge_mask_r=28, W.wq=22, M.q_mask1=22, M.q_mask2=22, R.normalize_r=off, R.wk_r=off, R.wq_r=off, R.wv_r=off, R.kt_mask1_r=off, R.q_mask1_r=off, R.q_mask2_r=off, R.qkt_matmul_r=off, K=**13** |
...
| L07 | B5 | F.inv_std_fresh=30, F.x_centered_fresh=30, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=off, R.gamma_r=28, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=off, R.gc1=off, R.gc2=off, R.gc3=off, K=**13** |
...
| L08 | B3 | F.x_fresh=28, S.inv_2n=15, R.sq0=31, R.sq1=31, R.sq2=29, R.sq3=31, R.x_inv_2n_r=off, K=**13** |
...
| L09 | B2 | F.inv_std_fresh=29, F.x_centered_fresh=30, M.gamma=20, W.wk=22, W.wv=22, M.kt_mask1=15, M.kt_mask2=15, M.qkt_merge_mask=15, R.gamma_r=31, R.kt_mask2_r=31, R.qkt_merge_mask_r=28, W.wq=22, M.q_mask1=22, M.q_mask2=22, R.normalize_r=off, R.wk_r=off, R.wq_r=off, R.wv_r=off, R.kt_mask1_r=off, R.q_mask1_r=off, R.q_mask2_r=off, R.qkt_matmul_r=off, K=**13** |
...
| L10 | B2 | F.inv_std_fresh=29, F.x_centered_fresh=30, M.gamma=20, W.wk=22, W.wv=22, M.kt_mask1=15, M.kt_mask2=15, M.qkt_merge_mask=15, R.gamma_r=31, R.kt_mask2_r=31, R.qkt_merge_mask_r=28, W.wq=22, M.q_mask1=22, M.q_mask2=22, R.normalize_r=off, R.wk_r=off, R.wq_r=off, R.wv_r=off, R.kt_mask1_r=off, R.q_mask1_r=off, R.q_mask2_r=off, R.qkt_matmul_r=off, K=**13** |
| L10 | B3 | F.x_fresh=28, S.inv_2n=15, R.sq0=31, R.sq1=31, R.sq2=31, R.sq3=29, R.x_inv_2n_r=off, K=**13** |
...
|---|:---:|---:|---:|---:|
| `L2.B2.M.kt_mask1` | `M` | 15 | 13 | -2 |
| `L7.B5.R.gamma_r` | `R` | 30 | 28 | -2 |
| `L8.B3.R.sq2` | `R` | 31 | 29 | -2 |
| `L9.B2.F.inv_std_fresh` | `F` | 31 | 29 | -2 |
| `L10.B2.F.inv_std_fresh` | `F` | 31 | 29 | -2 |
| `L10.B3.R.sq3` | `R` | 31 | 29 | -2 |
...
```
0, 0, 0, 0, 0, 0, 0, 0, 0, 4, 4, 2, 4, 4, 2, 2, 2, 3, 3, 3, 4, 2, 2, 0, 0, 0, 0, 0, 0, 0, 0, 3, 4, 2, 3, 3, 0, 0, 0, 3, 4, 4, 2, 2, 2, 2, 2, 4, 3, 3, 3, 0, 0, 0, 0, 0, 3, 4, 4, 2, 4, 2, 0, 3, 0, 0, 0, 0, 0, 0, 0, 0, 3, 4, 4, 2, 2, 3, 3, 0, 0, 3, 4, 4, 2, 4, 4, 2, 2, 2, 3, 3, 3, 4, 2, 2, 0, 0, 0, 0, 0, 0, 0, 0, 3, 4, 2, 3, 3, 0, 0, 0, 3, 4, 4, 2, 2, 2, 2, 2, 4, 3, 3, 3, 0, 0, 0, 0, 0, 3, 4, 4, 2, 4, 2, 0, 3, 0, 0, 0, 0, 0, 0, 0, 0, 3, 4,