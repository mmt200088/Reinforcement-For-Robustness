...
- rescale_optimizer_root: `/hy-tmp/fusion_count_baseline_repeat5_68176e0_20260702_155408/src/Rescale_optimizer`
- json: `/hy-tmp/fusion_count_baseline_repeat5_68176e0_20260702_155408/src/experiments/server_command_runs/fusion_count_baseline_repeat5_20260702_155430/paean_outputs/mrpc/rl/all_fusion0/final_eval/blb_action_final_eval_results_mrpc.json`

## Baseline

- clean baseline loss: `0.346254`
- clean baseline Acc.: `0.877451`
- clean baseline F1: `0.874422`
- clean baseline protocol: `repeated_mean_n=5`
...
- target total_bits_sum: `11285`
- target total_fusion_count: `0`
...
- selected (`ActionSelected`): loss=0.344278 ± 0.001379, Acc.=0.878922 ± 0.002500, F1=0.877336 ± 0.002332, total_bits=11285, fusion=0, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.344278 | 0.001379 | 0.878922 | 0.002500 | 0.877336 | 0.002332 | 117.084 | 11285 | 0 | True | True |
...
- fusion group diagnostics: `{'group_name': 'all_fusion0', 'declared_total_fusion_count': 0, 'realized_total_fusion_count': 0, 'declared_by_graph': {'block1_mrpc': 0, 'block2_mrpc': 0, 'block4': 0, 'block5_n0': 0, 'block5_n1': 0, 'block5_n2': 0, 'block5_n4': 0}, 'matches_realized_total': True}`
- handler active layers match expected: `True`
- handler cfg object identity match: `True`
- rescale optimizer: `{'invoker_kind': 'in_process', 'root': '/hy-tmp/fusion_count_baseline_repeat5_68176e0_20260702_155408/src/Rescale_optimizer', 'mode': 'cfg_derived', 'request_count': 47, 'valid_count': 47, 'invalid_count': 0, 't_new_sources': ['cfg_derived']}`
