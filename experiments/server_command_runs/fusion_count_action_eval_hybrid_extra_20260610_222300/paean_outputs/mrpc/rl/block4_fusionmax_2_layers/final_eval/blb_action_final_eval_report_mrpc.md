...
- json: `/hy-tmp/fusion_count_action_eval_hybrid_extra_0995eae_20260610_222300/src/experiments/server_command_runs/fusion_count_action_eval_hybrid_extra_20260610_222300/paean_outputs/mrpc/rl/block4_fusionmax_2_layers/final_eval/blb_action_final_eval_results_mrpc.json`
...
- selected (`ActionSelected`): loss=0.386767 ± 0.013256, Acc.=0.866667 ± 0.008290, F1=0.865032 ± 0.008114, total_bits=11177, fusion=2, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.386767 | 0.013256 | 0.866667 | 0.008290 | 0.865032 | 0.008114 | 124.714 | 11177 | 2 | True | True |
...
- fusion group diagnostics: `{'group_name': 'block4_fusionmax_2_layers', 'declared_total_fusion_count': 1, 'realized_total_fusion_count': 2, 'declared_by_graph': {'block1_mrpc': 0, 'block2_mrpc': 0, 'block4': 0, 'block5_n1': 0, 'block5_n2': 0, 'block5_n4': 0, 'block4_selected_layers': 1}, 'matches_realized_total': False}`
