...
- json: `/hy-tmp/fusion_count_action_eval_hybrid_extra_0995eae_20260610_222300/src/experiments/server_command_runs/fusion_count_action_eval_hybrid_extra_20260610_222300/paean_outputs/mrpc/rl/block4_fusionmax_1_layer/final_eval/blb_action_final_eval_results_mrpc.json`
...
- selected (`ActionSelected`): loss=0.388192 ± 0.005155, Acc.=0.869118 ± 0.003668, F1=0.867249 ± 0.003677, total_bits=11231, fusion=1, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.388192 | 0.005155 | 0.869118 | 0.003668 | 0.867249 | 0.003677 | 122.602 | 11231 | 1 | True | True |
...
- fusion group diagnostics: `{'group_name': 'block4_fusionmax_1_layer', 'declared_total_fusion_count': 1, 'realized_total_fusion_count': 1, 'declared_by_graph': {'block1_mrpc': 0, 'block2_mrpc': 0, 'block4': 0, 'block5_n1': 0, 'block5_n2': 0, 'block5_n4': 0, 'block4_selected_layers': 1}, 'matches_realized_total': True}`
