...
- json: `/hy-tmp/fusion_count_action_eval_hybrid_extra_0995eae_20260610_222300/src/experiments/server_command_runs/fusion_count_action_eval_hybrid_extra_20260610_222300/paean_outputs/mrpc/rl/all_fusion0/final_eval/blb_action_final_eval_results_mrpc.json`
...
- selected (`ActionSelected`): loss=0.383951 ± 0.001597, Acc.=0.876471 ± 0.002500, F1=0.875002 ± 0.002635, total_bits=11285, fusion=0, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.383951 | 0.001597 | 0.876471 | 0.002500 | 0.875002 | 0.002635 | 122.459 | 11285 | 0 | True | True |
...
- fusion group diagnostics: `{'group_name': 'all_fusion0', 'declared_total_fusion_count': 0, 'realized_total_fusion_count': 0, 'declared_by_graph': {'block1_mrpc': 0, 'block2_mrpc': 0, 'block4': 0, 'block5_n1': 0, 'block5_n2': 0, 'block5_n4': 0}, 'matches_realized_total': True}`
