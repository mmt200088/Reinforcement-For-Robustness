...
- json: `/hy-tmp/fusion_count_newenum_513a1ff_20260611_005952/src/experiments/server_command_runs/fusion_count_newenum_random_block4_eval_20260611/paean_outputs/mrpc/rl/trial1_block4_random_fusionmax_2_layers/final_eval/blb_action_final_eval_results_mrpc.json`
...
- selected (`ActionSelected`): loss=0.370360 ± 0.006935, Acc.=0.869118 ± 0.003325, F1=0.867579 ± 0.002963, total_bits=11179, fusion=2, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.370360 | 0.006935 | 0.869118 | 0.003325 | 0.867579 | 0.002963 | 269.783 | 11179 | 2 | True | True |
...
- fusion group diagnostics: `{'group_name': 'trial1_block4_random_fusionmax_2_layers', 'declared_total_fusion_count': 3, 'realized_total_fusion_count': 2, 'declared_by_graph': {'block1_mrpc': 0, 'block2_mrpc': 0, 'block4': 0, 'block5_n0': 0, 'block5_n1': 0, 'block5_n2': 0, 'block5_n4': 0, 'block4_selected_layers': 2, 'block4_fusion_per_selected_layer': 1}, 'matches_realized_total': False}`
