...
- json: `/hy-tmp/fusion_count_newenum_513a1ff_20260611_005952/src/experiments/server_command_runs/fusion_count_newenum_random_block4_eval_20260611/paean_outputs/mrpc/rl/trial2_block4_random_fusionmax_1_layers/final_eval/blb_action_final_eval_results_mrpc.json`
...
- selected (`ActionSelected`): loss=0.375344 ± 0.013589, Acc.=0.874510 ± 0.009480, F1=0.873218 ± 0.009381, total_bits=11232, fusion=1, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.375344 | 0.013589 | 0.874510 | 0.009480 | 0.873218 | 0.009381 | 249.062 | 11232 | 1 | True | True |
...
- fusion group diagnostics: `{'group_name': 'trial2_block4_random_fusionmax_1_layers', 'declared_total_fusion_count': 2, 'realized_total_fusion_count': 1, 'declared_by_graph': {'block1_mrpc': 0, 'block2_mrpc': 0, 'block4': 0, 'block5_n0': 0, 'block5_n1': 0, 'block5_n2': 0, 'block5_n4': 0, 'block4_selected_layers': 1, 'block4_fusion_per_selected_layer': 1}, 'matches_realized_total': False}`
