...
- Profile（数据集）: `mrpc`
- 生成时间: 2026-06-05T15:52:06.641667
- 训练时长: 1665.4 秒（约 27.8 分钟）
- Episode 进度: 600 / 600
- 模数链 invoker: `in_process_real`

## 1. Reward 概览

- 最优 reward (best): **+39.737194**
- 全程 episode reward 均值: -0.5711
- 全程 episode reward 最大值: +39.7372
- 全程 episode reward 最小值: -7.4208
- 全程 episode reward 标准差: 16.1385
...
|------|------|
| `terminal_priority` | 3 |
| `terminal_reward` | 42.07264133221358 |
| `terminal_cost_score` | 1.5785007072135786 |
| `terminal_cost_rank_score` | 2480.0 |
| `terminal_cost_rank_fusion` | 0.0 |
| `terminal_cost_rank_truncation` | 0.0 |
| `terminal_cost_rank_bits` | 0.0 |
| `terminal_p3_metric_margin_reward` | 0.4941406250000002 |
...
| `terminal_k_gain` | 1.5593220338983045 |
| `terminal_bits_gain` | 380.0 |
| `terminal_metric1_mean` | 0.8642578125 |
| `terminal_metric2_mean` | 0.8642578125 |
...
| 字段 | 值 |
|------|------|
| `total_bits_sum` | 11241 |
| `total_fusion_count` | 0 |
| `avg_k` | 13.0 |
| `loss_mean` | 0.3804325759410858 |
| `metric1_mean` | 0.86328125 |
| `metric2_mean` | 0.86328125 |
...
| `baseline_metric1` | 0.86328125 |
| `baseline_metric2` | 0.86328125 |
...
| L00 | B4 | F.softmax_out_fresh=29, F.v_fresh=25, M.softmax_out_mask=14, M.v_mask=14, M.softmax_v_mask=14, S.ln_mean_inv_d=16, S.ln_var_inv_d=20, W.wo=16, R.softmax_v_matmul_r=23, R.ln_mean_r=21, R.ln_var_r=off, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=31, K=**10** |
| L00 | B5 | F.inv_std_fresh=28, F.x_centered_fresh=28, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=26, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=29, R.gc1=off, R.gc2=off, R.gc3=off, K=**8** |
| L01 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=30, R.var_r=27, R.wffn2_r=off, R.square_r=off, K=**11** |
...
| L01 | B4 | F.softmax_out_fresh=29, F.v_fresh=25, M.softmax_out_mask=14, M.v_mask=14, M.softmax_v_mask=14, S.ln_mean_inv_d=16, S.ln_var_inv_d=20, W.wo=16, R.softmax_v_matmul_r=23, R.ln_mean_r=21, R.ln_var_r=off, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=31, K=**9** |
| L01 | B5 | F.inv_std_fresh=28, F.x_centered_fresh=28, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=26, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=29, R.gc1=off, R.gc2=off, R.gc3=off, K=**11** |
...
| L02 | B4 | F.softmax_out_fresh=29, F.v_fresh=25, M.softmax_out_mask=14, M.v_mask=14, M.softmax_v_mask=14, S.ln_mean_inv_d=16, S.ln_var_inv_d=20, W.wo=16, R.softmax_v_matmul_r=23, R.ln_mean_r=21, R.ln_var_r=off, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=31, K=**13** |
| L02 | B5 | F.inv_std_fresh=28, F.x_centered_fresh=28, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=26, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=29, R.gc1=off, R.gc2=off, R.gc3=off, K=**11** |
| L03 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=30, R.var_r=27, R.wffn2_r=off, R.square_r=off, K=**9** |
| L03 | B2 | F.inv_std_fresh=20, F.x_centered_fresh=28, M.gamma=16, W.wk=16, W.wv=22, M.kt_mask1=15, M.kt_mask2=15, M.qkt_merge_mask=15, R.gamma_r=28, R.kt_mask2_r=off, R.qkt_merge_mask_r=off, W.wq=22, M.q_mask1=15, M.q_mask2=15, R.normalize_r=off, R.wk_r=off, R.wq_r=off, R.wv_r=off, R.kt_mask1_r=28, R.q_mask1_r=28, R.q_mask2_r=off, R.qkt_matmul_r=28, K=**13** |
| L03 | B3 | F.x_fresh=28, S.inv_2n=15, R.sq0=31, R.sq1=31, R.sq2=31, R.sq3=31, R.x_inv_2n_r=22, K=**13** |
| L03 | B4 | F.softmax_out_fresh=35, F.v_fresh=25, M.softmax_out_mask=14, M.v_mask=14, M.softmax_v_mask=14, S.ln_mean_inv_d=20, S.ln_var_inv_d=20, W.wo=22, R.softmax_v_matmul_r=31, R.ln_mean_r=31, R.ln_var_r=off, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=31, K=**12** |
| L03 | B5 | F.inv_std_fresh=28, F.x_centered_fresh=28, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=26, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=29, R.gc1=off, R.gc2=off, R.gc3=off, K=**13** |
...
| L04 | B5 | F.inv_std_fresh=28, F.x_centered_fresh=22, M.gamma=14, W.wffn1=14, M.gelu_coeff=16, R.normalize_r=26, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=29, R.gc1=off, R.gc2=off, R.gc3=off, K=**9** |
| L05 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=30, R.var_r=27, R.wffn2_r=off, R.square_r=off, K=**10** |
...
| L05 | B5 | F.inv_std_fresh=31, F.x_centered_fresh=31, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=31, R.gamma_r=off, R.wffn1_r=31, R.gp0=31, R.gp1=off, R.gp2=off, R.gc0=31, R.gc1=off, R.gc2=off, R.gc3=off, K=**12** |
...
| L06 | B4 | F.softmax_out_fresh=29, F.v_fresh=25, M.softmax_out_mask=14, M.v_mask=14, M.softmax_v_mask=14, S.ln_mean_inv_d=16, S.ln_var_inv_d=20, W.wo=16, R.softmax_v_matmul_r=23, R.ln_mean_r=21, R.ln_var_r=off, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=31, K=**9** |
| L06 | B5 | F.inv_std_fresh=28, F.x_centered_fresh=22, M.gamma=14, W.wffn1=14, M.gelu_coeff=16, R.normalize_r=26, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=29, R.gc1=off, R.gc2=off, R.gc3=off, K=**10** |
| L07 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=30, R.var_r=27, R.wffn2_r=off, R.square_r=off, K=**13** |
| L07 | B2 | F.inv_std_fresh=20, F.x_centered_fresh=28, M.gamma=16, W.wk=16, W.wv=22, M.kt_mask1=15, M.kt_mask2=15, M.qkt_merge_mask=15, R.gamma_r=28, R.kt_mask2_r=off, R.qkt_merge_mask_r=off, W.wq=22, M.q_mask1=15, M.q_mask2=15, R.normalize_r=off, R.wk_r=off, R.wq_r=off, R.wv_r=off, R.kt_mask1_r=28, R.q_mask1_r=28, R.q_mask2_r=off, R.qkt_matmul_r=28, K=**13** |
...
| L07 | B5 | F.inv_std_fresh=28, F.x_centered_fresh=28, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=26, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=29, R.gc1=off, R.gc2=off, R.gc3=off, K=**11** |
| L08 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=30, R.var_r=27, R.wffn2_r=off, R.square_r=off, K=**12** |
...
| L08 | B5 | F.inv_std_fresh=28, F.x_centered_fresh=28, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=26, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=29, R.gc1=off, R.gc2=off, R.gc3=off, K=**11** |
| L09 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=30, R.var_r=27, R.wffn2_r=off, R.square_r=off, K=**8** |
...
| L09 | B5 | F.inv_std_fresh=28, F.x_centered_fresh=22, M.gamma=14, W.wffn1=14, M.gelu_coeff=16, R.normalize_r=26, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=29, R.gc1=off, R.gc2=off, R.gc3=off, K=**10** |
...
| L10 | B4 | F.softmax_out_fresh=29, F.v_fresh=25, M.softmax_out_mask=14, M.v_mask=14, M.softmax_v_mask=14, S.ln_mean_inv_d=16, S.ln_var_inv_d=20, W.wo=16, R.softmax_v_matmul_r=23, R.ln_mean_r=21, R.ln_var_r=off, R.softmax_out_mask_r=off, R.v_mask_r=off, R.softmax_v_mask_r=off, R.wo_r=off, R.ln_square_r=31, K=**13** |
| L10 | B5 | F.inv_std_fresh=28, F.x_centered_fresh=28, M.gamma=20, W.wffn1=22, M.gelu_coeff=20, R.normalize_r=26, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=29, R.gc1=off, R.gc2=off, R.gc3=off, K=**13** |
...
| L11 | B5 | F.inv_std_fresh=28, F.x_centered_fresh=22, M.gamma=14, W.wffn1=14, M.gelu_coeff=16, R.normalize_r=26, R.gamma_r=off, R.wffn1_r=off, R.gp0=off, R.gp1=off, R.gp2=off, R.gc0=29, R.gc1=off, R.gc2=off, R.gc3=off, K=**12** |
| (legacy) first_input | – | `scaling_factor=30` |

### 5.2 Best vs baseline · 哪些槽位变了

_共 147 个槽位发生变化（116 个 SF + 31 个 K bits）_
...
```
9, 9, 9, 9, 9, 9, 9, 9, 3, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 2, 9, 9, 9, 9, 9, 9, 9, 3, 6, 9, 9, 9, 9, 7, 9, 6, 5, 4, 0, 0, 0, 0, 0, 9, 4, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 0, 9, 9, 9, 9, 9, 9, 0, 0, 2, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 5, 9, 9, 9, 9, 9, 9, 9, 3, 6, 9, 9, 9, 9, 7, 9, 6, 5, 4, 0, 0, 0, 0, 0, 9, 1, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 2, 9, 9, 9, 9, 9, 9, 0, 0, 1, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 3, 9, 9, 9, 9, 9, 9, 9, 3, 6, 9, 9, 9, 9, 7, 9, 6, 5, 4, 0, 0, 0, 0, 0, 9, 3, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 2, 9, 9, 9, 9, 9, 9, 0, 0, 1, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 3, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 5, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 3, 9, 9, 9, 9, 9, 9, 0, 0, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 1, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 2, 9, 6, 6, 5, 7, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 1, 9, 9, 9, 9, 9, 9, 0, 0, 4, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 0, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 4, 9, 9, 9, 9, 9, 9, 0, 9, 9, 0, 0, 9, 0, 0, 0, 5, 9, 9, 9, 9, 9, 9, 0, 0, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 3, 9, 9, 9, 9, 9, 9, 9, 3, 6, 9, 9, 9, 9, 7, 9, 6, 5, 4, 0, 0, 0, 0, 0, 9, 1, 9, 6, 6, 5, 7, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 4, 9, 9, 9, 9, 9, 9, 0, 0, 3, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 3, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 1, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 2, 9, 9, 9, 9, 9, 9, 0, 0, 5, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 3, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 3, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 2, 9, 9, 9, 9, 9, 9, 0, 0, 0, 5, 9, 7, 6, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 0, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 3, 9, 6, 6, 5, 7, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 4, 9, 9, 9, 9, 9, 9, 0, 0, 1, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 3, 9, 9, 9, 9, 9, 9, 9, 3, 6, 9, 9, 9, 9, 7, 9, 6, 5, 4, 0, 0, 0, 0, 0, 9, 3, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 3, 9, 9, 9, 9, 9, 9, 0, 0, 2, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 9, 9, 9, 0, 0, 0, 0, 9, 9, 0, 9, 1, 9, 9, 9, 9, 9, 9, 9, 3, 9, 9, 9, 9, 9, 9, 9, 9, 9, 9, 0, 0, 0, 0, 0, 9, 3, 9, 6, 6, 5, 7, 9, 0, 0, 0, 0, 0, 9, 0, 0, 0, 5, 4
```
