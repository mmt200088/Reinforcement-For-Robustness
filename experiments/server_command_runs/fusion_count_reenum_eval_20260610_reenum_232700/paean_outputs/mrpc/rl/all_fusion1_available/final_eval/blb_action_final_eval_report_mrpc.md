...
- rescale_optimizer_root: `/hy-tmp/fusion_count_reenum_eval_18f4c9a_20260610_232513/src/Rescale_optimizer`
- json: `/hy-tmp/fusion_count_reenum_eval_18f4c9a_20260610_232513/src/experiments/server_command_runs/fusion_count_reenum_eval_20260610_reenum_232700/paean_outputs/mrpc/rl/all_fusion1_available/final_eval/blb_action_final_eval_results_mrpc.json`
...
- selected (`ActionSelected`): loss=0.379664 ± 0.016320, Acc.=0.856863 ± 0.008851, F1=0.856966 ± 0.008911, total_bits=9969, fusion=36, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.379664 | 0.016320 | 0.856863 | 0.008851 | 0.856966 | 0.008911 | 124.984 | 9969 | 36 | True | True |
...
- rescale optimizer: `{'invoker_kind': 'in_process', 'root': '/hy-tmp/fusion_count_reenum_eval_18f4c9a_20260610_232513/src/Rescale_optimizer', 'mode': 'cfg_derived', 'request_count': 47, 'valid_count': 47, 'invalid_count': 0, 't_new_sources': ['cfg_derived']}`
...
| layer0.block4.softmax_v_mask_encode | scaling_factor | encoding | 16384 | 10 |  | 10 | True |
...
| layer1.block4.softmax_v_mask_encode | scaling_factor | encoding | 16384 | 10 |  | 10 | True |
...
| layer3.block4.softmax_v_mask_encode | scaling_factor | encoding | 16384 | 10 |  | 10 | True |
