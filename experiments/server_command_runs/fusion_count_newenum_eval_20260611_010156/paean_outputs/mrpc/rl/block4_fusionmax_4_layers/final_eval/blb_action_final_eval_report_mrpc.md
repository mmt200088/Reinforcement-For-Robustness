...
- json: `/hy-tmp/fusion_count_newenum_513a1ff_20260611_005952/src/experiments/server_command_runs/fusion_count_newenum_eval_20260611_010156/paean_outputs/mrpc/rl/block4_fusionmax_4_layers/final_eval/blb_action_final_eval_results_mrpc.json`
...
- selected (`ActionSelected`): loss=0.373011 ± 0.014265, Acc.=0.851961 ± 0.013917, F1=0.852906 ± 0.013550, total_bits=11073, fusion=4, avg_k=13.000
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| `ActionSelected` | 13 | 59 | 0.373011 | 0.014265 | 0.851961 | 0.013917 | 0.852906 | 0.013550 | 130.395 | 11073 | 4 | True | True |
...
- fusion group diagnostics: `{'group_name': 'block4_fusionmax_4_layers', 'declared_total_fusion_count': 1, 'realized_total_fusion_count': 4, 'declared_by_graph': {'block1_mrpc': 0, 'block2_mrpc': 0, 'block4': 0, 'block5_n1': 0, 'block5_n2': 0, 'block5_n4': 0, 'block4_selected_layers': 1}, 'matches_realized_total': False}`
