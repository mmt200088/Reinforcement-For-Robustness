...
_更新时间: 2026-05-19 20:32:29_  ·  累计用时: **9m25s**
...
- 已完成回合数: **200**
- 最近 50 回合 mean return: **-7.8689** (min=-7.9019, max=-7.8261)
- 最近 50 回合 mean terminal reward: **-5.0000**
- 最近 50 回合 mean invalid 子步数: **0.00** / 59
- 训练期 best reward: **+38.1492**
- 训练期 worst reward: **-7.9019**
- PPO 更新次数: **3**
...
|-----:|--------:|-------------:|---------:|-------------:|------:|--------:|-----------:|-------:|
| 1 | 88 | +38.1492 | +41.1220 | -2.9728 | 59 | 0 | 14779 | 0 |
| 2 | 97 | +38.0882 | +41.0610 | -2.9728 | 59 | 0 | 14779 | 0 |
| 3 | 115 | +38.0882 | +41.0610 | -2.9728 | 59 | 0 | 14779 | 0 |
| 4 | 26 | +38.0272 | +41.0000 | -2.9728 | 59 | 0 | 14779 | 0 |
| 5 | 7 | +38.0272 | +41.0000 | -2.9728 | 59 | 0 | 14779 | 0 |
| 6 | 3 | +38.0272 | +41.0000 | -2.9728 | 59 | 0 | 14779 | 0 |
| 7 | 87 | +38.0272 | +41.0000 | -2.9728 | 59 | 0 | 14779 | 0 |
| 8 | 53 | +38.0272 | +41.0000 | -2.9728 | 59 | 0 | 14779 | 0 |
| 9 | 6 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
| 10 | 21 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
| 11 | 11 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
| 12 | 42 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
| 13 | 28 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
| 14 | 118 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
| 15 | 30 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
| 16 | 64 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
| 17 | 85 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
| 18 | 69 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
| 19 | 95 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
| 20 | 79 | +37.9662 | +40.9390 | -2.9728 | 59 | 0 | 14779 | 0 |
...
|------:|----:|------------:|-----------:|--------:|----------:|---------:|-------------:|-------------:|
| 1 | 60 | -0.1551 | +1.4195 | +4.8670 | 0.867 | 0.00000 | +37.7681 | 0.00 |
| 2 | 120 | -0.1645 | +0.6790 | +4.3862 | 0.894 | 0.00000 | +37.7569 | 0.00 |
| 3 | 180 | +0.0007 | +0.9252 | +4.6947 | 0.575 | 0.00500 | -7.8815 | 0.00 |

_Entropy 趋势：+4.8670 → +4.6947（下降（policy 在收敛））_

## 5. 动作分布概览（哪些 slot 已经在按 baseline 取最大档）

- **已收敛 slot**（top-1 占比 > 85%）：**404** / 577
- **未收敛 slot**：**173** / 577

## 6. 自动诊断（auto-flags）

- ⚠ **学习退化**：最近 20 回合平均回报 -7.8463 低于前 20 回合 +37.7650（Δ=-45.6113）。建议：降低 lr / 增加 ent_coef / 检查 invalid_penalty 是否过强。
...
bash Paean/run_final_eval.sh \
    ...
    --action-config Parting Chapter/persistent/rl/bert-base/mrpc/s1t0.005_s2t0.005_s2st0.005__bench_single_20260519_202236/stage2_noise/progress/diagnostics/best_action_vec.json
```
