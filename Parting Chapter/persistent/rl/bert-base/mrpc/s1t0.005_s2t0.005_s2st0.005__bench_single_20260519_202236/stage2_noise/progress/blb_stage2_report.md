...
- 运行名（run_basename）: `s1t0.005_s2t0.005_s2st0.005__bench_single_20260519_202236`
- Profile（数据集）: `mrpc`
- 生成时间: 2026-05-19T20:32:29.339772
- 训练时长: 565.3 秒（约 9.4 分钟）
- Episode 进度: 200 / 200
- 模数链 invoker: `in_process_real`

## 1. Reward 概览

- 最优 reward (best): **+38.149169**
- 全程 episode reward 均值: +19.5084
- 全程 episode reward 最大值: +38.1492
- 全程 episode reward 最小值: -7.9019
- 全程 episode reward 标准差: 22.3569
