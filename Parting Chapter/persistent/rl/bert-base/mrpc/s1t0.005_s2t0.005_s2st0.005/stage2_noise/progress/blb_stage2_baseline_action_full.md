...
| 11 | `L0.B2.M.gamma` | `layer0.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 15 | `L0.B2.M.kt_mask1` | `layer0.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 16 | `L0.B2.M.kt_mask2` | `layer0.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 17 | `L0.B2.M.q_mask1` | `layer0.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 18 | `L0.B2.M.q_mask2` | `layer0.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 19 | `L0.B2.M.qkt_merge_mask` | `layer0.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 42 | `L0.B4.M.softmax_out_mask` | `layer0.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 43 | `L0.B4.M.v_mask` | `layer0.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 44 | `L0.B4.M.softmax_v_mask` | `layer0.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 59 | `L0.B5.M.gamma` | `layer0.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
| 60 | `L0.B5.W.wffn1` | `layer0.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 8192 | 22 |  |
| 61 | `L0.B5.M.gelu_coeff` | `layer0.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
...
| 84 | `L1.B2.M.gamma` | `layer1.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 88 | `L1.B2.M.kt_mask1` | `layer1.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 89 | `L1.B2.M.kt_mask2` | `layer1.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 90 | `L1.B2.M.q_mask1` | `layer1.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 91 | `L1.B2.M.q_mask2` | `layer1.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 92 | `L1.B2.M.qkt_merge_mask` | `layer1.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 115 | `L1.B4.M.softmax_out_mask` | `layer1.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 116 | `L1.B4.M.v_mask` | `layer1.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 117 | `L1.B4.M.softmax_v_mask` | `layer1.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 132 | `L1.B5.M.gamma` | `layer1.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
| 133 | `L1.B5.W.wffn1` | `layer1.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 8192 | 22 |  |
| 134 | `L1.B5.M.gelu_coeff` | `layer1.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
...
| 157 | `L2.B2.M.gamma` | `layer2.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 161 | `L2.B2.M.kt_mask1` | `layer2.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 162 | `L2.B2.M.kt_mask2` | `layer2.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 163 | `L2.B2.M.q_mask1` | `layer2.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 164 | `L2.B2.M.q_mask2` | `layer2.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 165 | `L2.B2.M.qkt_merge_mask` | `layer2.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 188 | `L2.B4.M.softmax_out_mask` | `layer2.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 189 | `L2.B4.M.v_mask` | `layer2.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 190 | `L2.B4.M.softmax_v_mask` | `layer2.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 205 | `L2.B5.M.gamma` | `layer2.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
| 206 | `L2.B5.W.wffn1` | `layer2.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 8192 | 22 |  |
| 207 | `L2.B5.M.gelu_coeff` | `layer2.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
...
| 230 | `L3.B2.M.gamma` | `layer3.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 234 | `L3.B2.M.kt_mask1` | `layer3.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 235 | `L3.B2.M.kt_mask2` | `layer3.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 236 | `L3.B2.M.q_mask1` | `layer3.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 237 | `L3.B2.M.q_mask2` | `layer3.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 238 | `L3.B2.M.qkt_merge_mask` | `layer3.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 261 | `L3.B4.M.softmax_out_mask` | `layer3.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 262 | `L3.B4.M.v_mask` | `layer3.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 263 | `L3.B4.M.softmax_v_mask` | `layer3.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 278 | `L3.B5.M.gamma` | `layer3.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
| 279 | `L3.B5.W.wffn1` | `layer3.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 8192 | 22 |  |
| 280 | `L3.B5.M.gelu_coeff` | `layer3.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
...
| 303 | `L4.B2.M.gamma` | `layer4.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 307 | `L4.B2.M.kt_mask1` | `layer4.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 308 | `L4.B2.M.kt_mask2` | `layer4.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 309 | `L4.B2.M.q_mask1` | `layer4.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 310 | `L4.B2.M.q_mask2` | `layer4.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 311 | `L4.B2.M.qkt_merge_mask` | `layer4.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 334 | `L4.B4.M.softmax_out_mask` | `layer4.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 335 | `L4.B4.M.v_mask` | `layer4.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 336 | `L4.B4.M.softmax_v_mask` | `layer4.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 351 | `L4.B5.M.gamma` | `layer4.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
| 352 | `L4.B5.W.wffn1` | `layer4.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 8192 | 22 |  |
| 353 | `L4.B5.M.gelu_coeff` | `layer4.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
...
| 376 | `L5.B2.M.gamma` | `layer5.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 380 | `L5.B2.M.kt_mask1` | `layer5.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 381 | `L5.B2.M.kt_mask2` | `layer5.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 382 | `L5.B2.M.q_mask1` | `layer5.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 383 | `L5.B2.M.q_mask2` | `layer5.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 384 | `L5.B2.M.qkt_merge_mask` | `layer5.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 407 | `L5.B4.M.softmax_out_mask` | `layer5.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 408 | `L5.B4.M.v_mask` | `layer5.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 409 | `L5.B4.M.softmax_v_mask` | `layer5.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 424 | `L5.B5.M.gamma` | `layer5.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
| 425 | `L5.B5.W.wffn1` | `layer5.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 426 | `L5.B5.M.gelu_coeff` | `layer5.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 449 | `L6.B2.M.gamma` | `layer6.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 453 | `L6.B2.M.kt_mask1` | `layer6.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 454 | `L6.B2.M.kt_mask2` | `layer6.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 455 | `L6.B2.M.q_mask1` | `layer6.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 456 | `L6.B2.M.q_mask2` | `layer6.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 457 | `L6.B2.M.qkt_merge_mask` | `layer6.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 480 | `L6.B4.M.softmax_out_mask` | `layer6.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 481 | `L6.B4.M.v_mask` | `layer6.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 482 | `L6.B4.M.softmax_v_mask` | `layer6.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 497 | `L6.B5.M.gamma` | `layer6.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
| 498 | `L6.B5.W.wffn1` | `layer6.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 8192 | 22 |  |
| 499 | `L6.B5.M.gelu_coeff` | `layer6.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
...
| 522 | `L7.B2.M.gamma` | `layer7.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 526 | `L7.B2.M.kt_mask1` | `layer7.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 527 | `L7.B2.M.kt_mask2` | `layer7.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 528 | `L7.B2.M.q_mask1` | `layer7.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 529 | `L7.B2.M.q_mask2` | `layer7.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 530 | `L7.B2.M.qkt_merge_mask` | `layer7.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 553 | `L7.B4.M.softmax_out_mask` | `layer7.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 554 | `L7.B4.M.v_mask` | `layer7.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 555 | `L7.B4.M.softmax_v_mask` | `layer7.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 570 | `L7.B5.M.gamma` | `layer7.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
| 571 | `L7.B5.W.wffn1` | `layer7.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 8192 | 22 |  |
| 572 | `L7.B5.M.gelu_coeff` | `layer7.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
...
| 595 | `L8.B2.M.gamma` | `layer8.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 599 | `L8.B2.M.kt_mask1` | `layer8.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 600 | `L8.B2.M.kt_mask2` | `layer8.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 601 | `L8.B2.M.q_mask1` | `layer8.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 602 | `L8.B2.M.q_mask2` | `layer8.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 603 | `L8.B2.M.qkt_merge_mask` | `layer8.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 626 | `L8.B4.M.softmax_out_mask` | `layer8.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 627 | `L8.B4.M.v_mask` | `layer8.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 628 | `L8.B4.M.softmax_v_mask` | `layer8.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 643 | `L8.B5.M.gamma` | `layer8.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
| 644 | `L8.B5.W.wffn1` | `layer8.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 8192 | 22 |  |
| 645 | `L8.B5.M.gelu_coeff` | `layer8.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
...
| 668 | `L9.B2.M.gamma` | `layer9.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 672 | `L9.B2.M.kt_mask1` | `layer9.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 673 | `L9.B2.M.kt_mask2` | `layer9.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 674 | `L9.B2.M.q_mask1` | `layer9.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 675 | `L9.B2.M.q_mask2` | `layer9.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 676 | `L9.B2.M.qkt_merge_mask` | `layer9.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 699 | `L9.B4.M.softmax_out_mask` | `layer9.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 700 | `L9.B4.M.v_mask` | `layer9.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 701 | `L9.B4.M.softmax_v_mask` | `layer9.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 716 | `L9.B5.M.gamma` | `layer9.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
| 717 | `L9.B5.W.wffn1` | `layer9.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 8192 | 22 |  |
| 718 | `L9.B5.M.gelu_coeff` | `layer9.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
...
| 741 | `L10.B2.M.gamma` | `layer10.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 745 | `L10.B2.M.kt_mask1` | `layer10.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 746 | `L10.B2.M.kt_mask2` | `layer10.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 747 | `L10.B2.M.q_mask1` | `layer10.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 748 | `L10.B2.M.q_mask2` | `layer10.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 749 | `L10.B2.M.qkt_merge_mask` | `layer10.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 772 | `L10.B4.M.softmax_out_mask` | `layer10.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 773 | `L10.B4.M.v_mask` | `layer10.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 774 | `L10.B4.M.softmax_v_mask` | `layer10.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 789 | `L10.B5.M.gamma` | `layer10.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
| 790 | `L10.B5.W.wffn1` | `layer10.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 8192 | 22 |  |
| 791 | `L10.B5.M.gelu_coeff` | `layer10.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
...
| 814 | `L11.B2.M.gamma` | `layer11.block2.gamma_sf` | `ctpt_gamma` | `encoding` | 2 | `scaling_factor` | 20 | True | 16384 | 20 |  |
...
| 818 | `L11.B2.M.kt_mask1` | `layer11.block2.kt_mask1_sf` | `ctpt_kt_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 819 | `L11.B2.M.kt_mask2` | `layer11.block2.kt_mask2_sf` | `ctpt_kt_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 820 | `L11.B2.M.q_mask1` | `layer11.block2.q_mask1_sf` | `ctpt_q_mask1` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 821 | `L11.B2.M.q_mask2` | `layer11.block2.q_mask2_sf` | `ctpt_q_mask2` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
| 822 | `L11.B2.M.qkt_merge_mask` | `layer11.block2.qkt_merge_mask_sf` | `ctpt_qkt_merge_mask` | `encoding` | 2 | `scaling_factor` | 15 | True | 16384 | 15 |  |
...
| 845 | `L11.B4.M.softmax_out_mask` | `layer11.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
| 846 | `L11.B4.M.v_mask` | `layer11.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | 2 | `scaling_factor` | 22 | True | 16384 | 22 |  |
| 847 | `L11.B4.M.softmax_v_mask` | `layer11.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | 2 | `scaling_factor` | 14 | True | 16384 | 14 |  |
...
| 862 | `L11.B5.M.gamma` | `layer11.block5.gamma_sf` | `ctpt_gamma_attn` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
| 863 | `L11.B5.W.wffn1` | `layer11.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | 4 | `scaling_factor` | 22 | True | 8192 | 22 |  |
| 864 | `L11.B5.M.gelu_coeff` | `layer11.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | 2 | `scaling_factor` | 20 | True | 8192 | 20 |  |
