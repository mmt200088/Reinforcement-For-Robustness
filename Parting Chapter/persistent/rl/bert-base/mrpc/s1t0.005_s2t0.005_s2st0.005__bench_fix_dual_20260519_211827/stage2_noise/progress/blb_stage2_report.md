...
- 运行名（run_basename）: `s1t0.005_s2t0.005_s2st0.005__bench_fix_dual_20260519_211827`
- Profile（数据集）: `mrpc`
- 生成时间: 2026-05-19T21:34:56.323573
- 训练时长: 358.4 秒（约 6.0 分钟）
- Episode 进度: 200 / 200
- 模数链 invoker: `in_process_real`

## 1. Reward 概览

- 最优 reward (best): **+37.761593**
- 全程 episode reward 均值: +8.4891
- 全程 episode reward 最大值: +37.7616
- 全程 episode reward 最小值: -7.9023
- 全程 episode reward 标准差: 20.4805
