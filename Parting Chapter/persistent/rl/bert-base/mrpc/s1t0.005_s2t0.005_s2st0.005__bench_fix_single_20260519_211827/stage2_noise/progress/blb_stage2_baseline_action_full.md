...
| 层 | block | 槽位 → 选择值 |
|---|---|---|
| L00 | B1 | F.gelu_out=30, W.wffn2=20, S.mean_inv_d=20, S.var_inv_d=20, R.mean_r=off, R.var_r=off, K=**13** |
...
|---:|---|---|---|:---:|---:|:---:|---:|:---:|---:|---:|---|---|
| 0 | `L0.B1.F.gelu_out` | `layer0.block1.gelu_out_sf` | `ctpt_gelu_out` | `fresh` | _off_ | `F` | 4 | False | 8192 | 30 | `22,24,26,28,30` | layer 0 has no upstream FFN2; the first HE config is treated as lossless so block1 noise is not installed (aligned with Rescale_optimizer) |
| 1 | `L0.B1.W.wffn2` | `layer0.block1.wffn2_sf` | `ctpt_ffn2` | `encoding` | _off_ | `W` | 4 | False | 8192 | 20 | `12,14,16,18,20` | layer 0 has no upstream FFN2; the first HE config is treated as lossless so block1 noise is not installed (aligned with Rescale_optimizer) |
| 2 | `L0.B1.S.mean_inv_d` | `layer0.block1.mean_inv_d_sf` | `ctpt_inv_d_1` | `scalar` | _off_ | `S` | 2 | False | 8192 | 20 | `16,18,20` | layer 0 has no upstream FFN2; the first HE config is treated as lossless so block1 noise is not installed (aligned with Rescale_optimizer) |
| 3 | `L0.B1.S.var_inv_d` | `layer0.block1.var_inv_d_sf` | `ctpt_inv_d_2` | `scalar` | _off_ | `S` | 2 | False | 8192 | 20 | `16,18,20` | layer 0 has no upstream FFN2; the first HE config is treated as lossless so block1 noise is not installed (aligned with Rescale_optimizer) |
...
| 6 | `L0.B1.K` | `layer0.block1.output_truncation_k` | `block1_output_truncation` | `truncation` | _off_ | `K` | 3 | False | 8192 |  | `8,9,11,13,10,12` | layer 0 has no upstream FFN2; the first HE config is treated as lossless so block1 noise is not installed (aligned with Rescale_optimizer) |
| 7 | `L0.B2.F.inv_std_fresh` | `layer0.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
| 8 | `L0.B2.F.x_centered_fresh` | `layer0.block2.x_centered_fresh_sf` | `ctpt_x_centered` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 9 | `L0.B2.M.gamma` | `layer0.block2.gamma_sf` | `ctpt_gamma` | `encoding` | **20** | `M` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 10 | `L0.B2.W.wk` | `layer0.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 11 | `L0.B2.W.wv` | `layer0.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 12 | `L0.B2.M.kt_mask1` | `layer0.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 13 | `L0.B2.M.kt_mask2` | `layer0.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 14 | `L0.B2.M.qkt_merge_mask` | `layer0.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 15 | `L0.B2.R.gamma_r` | `layer0.block2.gamma_rescale_sf` | `ctct_gamma_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 19 | `L0.B3.F.x_fresh` | `layer0.block3.x_fresh_sf` | `ctpt_softmax_x` | `fresh` | **27** | `F` | 4 | True | 8192 | 27 | `19,21,23,25,27` |  |
| 20 | `L0.B3.S.inv_2n` | `layer0.block3.inv_2n_sf` | `ctpt_softmax_inv_2n` | `scalar` | **16** | `S` | 2 | True | 8192 | 16 | `12,14,16` |  |
| 21 | `L0.B3.R.sq0` | `layer0.block3.square_rescale_sf_0` | `ctct_softmax_pow_s1` | `rescale` | **34** | `R` | 3 | True | 8192 | 34 | `None,30,32,34` |  |
| 22 | `L0.B3.R.sq1` | `layer0.block3.square_rescale_sf_1` | `ctct_softmax_pow_s2` | `rescale` | **34** | `R` | 3 | True | 8192 | 34 | `None,30,32,34` |  |
...
| 25 | `L0.B3.K` | `layer0.block3.output_truncation_k` | `block3_output_truncation` | `truncation` | **13** | `K` | 3 | True | 8192 |  | `8,9,11,13,10,12` |  |
| 26 | `L0.B4.F.softmax_out_fresh` | `layer0.block4.softmax_out_fresh_sf` | `ctpt_softmax_out` | `fresh` | **35** | `F` | 4 | True | 16384 | 35 | `27,29,31,33,35` |  |
| 27 | `L0.B4.F.v_fresh` | `layer0.block4.v_fresh_sf` | `ctpt_v` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
...
| 31 | `L0.B4.S.ln_mean_inv_d` | `layer0.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 32 | `L0.B4.S.ln_var_inv_d` | `layer0.block4.ln_var_inv_d_sf` | `ctpt_inv_d_attn_var` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 33 | `L0.B4.W.wo` | `layer0.block4.wo_sf` | `ctpt_wo` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 34 | `L0.B4.R.softmax_v_matmul_r` | `layer0.block4.softmax_v_matmul_rescale_sf` | `ctct_softmax_v_matmul_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 55 | `L1.B2.F.inv_std_fresh` | `layer1.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
| 56 | `L1.B2.F.x_centered_fresh` | `layer1.block2.x_centered_fresh_sf` | `ctpt_x_centered` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 57 | `L1.B2.M.gamma` | `layer1.block2.gamma_sf` | `ctpt_gamma` | `encoding` | **20** | `M` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 58 | `L1.B2.W.wk` | `layer1.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 59 | `L1.B2.W.wv` | `layer1.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 60 | `L1.B2.M.kt_mask1` | `layer1.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 61 | `L1.B2.M.kt_mask2` | `layer1.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 62 | `L1.B2.M.qkt_merge_mask` | `layer1.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 63 | `L1.B2.R.gamma_r` | `layer1.block2.gamma_rescale_sf` | `ctct_gamma_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 67 | `L1.B3.F.x_fresh` | `layer1.block3.x_fresh_sf` | `ctpt_softmax_x` | `fresh` | **27** | `F` | 4 | True | 8192 | 27 | `19,21,23,25,27` |  |
| 68 | `L1.B3.S.inv_2n` | `layer1.block3.inv_2n_sf` | `ctpt_softmax_inv_2n` | `scalar` | **16** | `S` | 2 | True | 8192 | 16 | `12,14,16` |  |
| 69 | `L1.B3.R.sq0` | `layer1.block3.square_rescale_sf_0` | `ctct_softmax_pow_s1` | `rescale` | **34** | `R` | 3 | True | 8192 | 34 | `None,30,32,34` |  |
| 70 | `L1.B3.R.sq1` | `layer1.block3.square_rescale_sf_1` | `ctct_softmax_pow_s2` | `rescale` | **34** | `R` | 3 | True | 8192 | 34 | `None,30,32,34` |  |
| 71 | `L1.B3.R.sq2` | `layer1.block3.square_rescale_sf_2` | `ctct_softmax_pow_s3` | `rescale` | _off_ | `R` | 0 | False | 8192 | 31 | `None,27,29,31` | softmax degree 2 does not use this square-rescale slot |
...
| 73 | `L1.B3.K` | `layer1.block3.output_truncation_k` | `block3_output_truncation` | `truncation` | **13** | `K` | 3 | True | 8192 |  | `8,9,11,13,10,12` |  |
| 74 | `L1.B4.F.softmax_out_fresh` | `layer1.block4.softmax_out_fresh_sf` | `ctpt_softmax_out` | `fresh` | **35** | `F` | 4 | True | 16384 | 35 | `27,29,31,33,35` |  |
| 75 | `L1.B4.F.v_fresh` | `layer1.block4.v_fresh_sf` | `ctpt_v` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 76 | `L1.B4.M.softmax_out_mask` | `layer1.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 77 | `L1.B4.M.v_mask` | `layer1.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 78 | `L1.B4.M.softmax_v_mask` | `layer1.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 79 | `L1.B4.S.ln_mean_inv_d` | `layer1.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 80 | `L1.B4.S.ln_var_inv_d` | `layer1.block4.ln_var_inv_d_sf` | `ctpt_inv_d_attn_var` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
...
| 84 | `L1.B4.R.ln_var_r` | `layer1.block4.ln_var_rescale_sf` | `ctct_attn_var_rescale` | `rescale` | **28** | `R` | 3 | True | 16384 | 28 | `None,24,26,28` |  |
...
| 103 | `L2.B2.F.inv_std_fresh` | `layer2.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
| 104 | `L2.B2.F.x_centered_fresh` | `layer2.block2.x_centered_fresh_sf` | `ctpt_x_centered` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 105 | `L2.B2.M.gamma` | `layer2.block2.gamma_sf` | `ctpt_gamma` | `encoding` | **20** | `M` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 106 | `L2.B2.W.wk` | `layer2.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 107 | `L2.B2.W.wv` | `layer2.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 108 | `L2.B2.M.kt_mask1` | `layer2.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 109 | `L2.B2.M.kt_mask2` | `layer2.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 110 | `L2.B2.M.qkt_merge_mask` | `layer2.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 111 | `L2.B2.R.gamma_r` | `layer2.block2.gamma_rescale_sf` | `ctct_gamma_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 115 | `L2.B3.F.x_fresh` | `layer2.block3.x_fresh_sf` | `ctpt_softmax_x` | `fresh` | **28** | `F` | 4 | True | 16384 | 28 | `20,22,24,26,28` |  |
...
| 118 | `L2.B3.R.sq1` | `layer2.block3.square_rescale_sf_1` | `ctct_softmax_pow_s2` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 119 | `L2.B3.R.sq2` | `layer2.block3.square_rescale_sf_2` | `ctct_softmax_pow_s3` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 120 | `L2.B3.R.sq3` | `layer2.block3.square_rescale_sf_3` | `ctct_softmax_pow_s4` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 121 | `L2.B3.K` | `layer2.block3.output_truncation_k` | `block3_output_truncation` | `truncation` | **13** | `K` | 3 | True | 16384 |  | `8,9,11,13,10,12` |  |
...
| 123 | `L2.B4.F.v_fresh` | `layer2.block4.v_fresh_sf` | `ctpt_v` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 124 | `L2.B4.M.softmax_out_mask` | `layer2.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 125 | `L2.B4.M.v_mask` | `layer2.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 126 | `L2.B4.M.softmax_v_mask` | `layer2.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 127 | `L2.B4.S.ln_mean_inv_d` | `layer2.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 128 | `L2.B4.S.ln_var_inv_d` | `layer2.block4.ln_var_inv_d_sf` | `ctpt_inv_d_attn_var` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 129 | `L2.B4.W.wo` | `layer2.block4.wo_sf` | `ctpt_wo` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 130 | `L2.B4.R.softmax_v_matmul_r` | `layer2.block4.softmax_v_matmul_rescale_sf` | `ctct_softmax_v_matmul_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 151 | `L3.B2.F.inv_std_fresh` | `layer3.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
| 152 | `L3.B2.F.x_centered_fresh` | `layer3.block2.x_centered_fresh_sf` | `ctpt_x_centered` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 153 | `L3.B2.M.gamma` | `layer3.block2.gamma_sf` | `ctpt_gamma` | `encoding` | **20** | `M` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 154 | `L3.B2.W.wk` | `layer3.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 155 | `L3.B2.W.wv` | `layer3.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 156 | `L3.B2.M.kt_mask1` | `layer3.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 157 | `L3.B2.M.kt_mask2` | `layer3.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 158 | `L3.B2.M.qkt_merge_mask` | `layer3.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 159 | `L3.B2.R.gamma_r` | `layer3.block2.gamma_rescale_sf` | `ctct_gamma_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 170 | `L3.B4.F.softmax_out_fresh` | `layer3.block4.softmax_out_fresh_sf` | `ctpt_softmax_out` | `fresh` | **35** | `F` | 4 | True | 16384 | 35 | `27,29,31,33,35` |  |
| 171 | `L3.B4.F.v_fresh` | `layer3.block4.v_fresh_sf` | `ctpt_v` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
...
| 175 | `L3.B4.S.ln_mean_inv_d` | `layer3.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
...
| 178 | `L3.B4.R.softmax_v_matmul_r` | `layer3.block4.softmax_v_matmul_rescale_sf` | `ctct_softmax_v_matmul_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 199 | `L4.B2.F.inv_std_fresh` | `layer4.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
| 200 | `L4.B2.F.x_centered_fresh` | `layer4.block2.x_centered_fresh_sf` | `ctpt_x_centered` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 201 | `L4.B2.M.gamma` | `layer4.block2.gamma_sf` | `ctpt_gamma` | `encoding` | **20** | `M` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 202 | `L4.B2.W.wk` | `layer4.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 203 | `L4.B2.W.wv` | `layer4.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 204 | `L4.B2.M.kt_mask1` | `layer4.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 205 | `L4.B2.M.kt_mask2` | `layer4.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 206 | `L4.B2.M.qkt_merge_mask` | `layer4.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 207 | `L4.B2.R.gamma_r` | `layer4.block2.gamma_rescale_sf` | `ctct_gamma_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 218 | `L4.B4.F.softmax_out_fresh` | `layer4.block4.softmax_out_fresh_sf` | `ctpt_softmax_out` | `fresh` | **35** | `F` | 4 | True | 16384 | 35 | `27,29,31,33,35` |  |
...
| 221 | `L4.B4.M.v_mask` | `layer4.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 222 | `L4.B4.M.softmax_v_mask` | `layer4.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 223 | `L4.B4.S.ln_mean_inv_d` | `layer4.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 224 | `L4.B4.S.ln_var_inv_d` | `layer4.block4.ln_var_inv_d_sf` | `ctpt_inv_d_attn_var` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 225 | `L4.B4.W.wo` | `layer4.block4.wo_sf` | `ctpt_wo` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 226 | `L4.B4.R.softmax_v_matmul_r` | `layer4.block4.softmax_v_matmul_rescale_sf` | `ctct_softmax_v_matmul_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 227 | `L4.B4.R.ln_mean_r` | `layer4.block4.ln_mean_rescale_sf` | `ctct_attn_mean_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 228 | `L4.B4.R.ln_var_r` | `layer4.block4.ln_var_rescale_sf` | `ctct_attn_var_rescale` | `rescale` | **28** | `R` | 3 | True | 16384 | 28 | `None,24,26,28` |  |
...
| 247 | `L5.B2.F.inv_std_fresh` | `layer5.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
...
| 250 | `L5.B2.W.wk` | `layer5.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 251 | `L5.B2.W.wv` | `layer5.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 252 | `L5.B2.M.kt_mask1` | `layer5.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 253 | `L5.B2.M.kt_mask2` | `layer5.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 254 | `L5.B2.M.qkt_merge_mask` | `layer5.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 255 | `L5.B2.R.gamma_r` | `layer5.block2.gamma_rescale_sf` | `ctct_gamma_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 257 | `L5.B2.R.qkt_merge_mask_r` | `layer5.block2.qkt_merge_mask_rescale_sf` | `ctct_qkt_merge_mask_rescale` | `rescale` | **28** | `R` | 3 | True | 16384 | 28 | `None,24,26,28` |  |
...
| 266 | `L5.B4.F.softmax_out_fresh` | `layer5.block4.softmax_out_fresh_sf` | `ctpt_softmax_out` | `fresh` | **35** | `F` | 4 | True | 16384 | 35 | `27,29,31,33,35` |  |
...
| 269 | `L5.B4.M.v_mask` | `layer5.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 270 | `L5.B4.M.softmax_v_mask` | `layer5.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 271 | `L5.B4.S.ln_mean_inv_d` | `layer5.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 272 | `L5.B4.S.ln_var_inv_d` | `layer5.block4.ln_var_inv_d_sf` | `ctpt_inv_d_attn_var` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 273 | `L5.B4.W.wo` | `layer5.block4.wo_sf` | `ctpt_wo` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 274 | `L5.B4.R.softmax_v_matmul_r` | `layer5.block4.softmax_v_matmul_rescale_sf` | `ctct_softmax_v_matmul_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 278 | `L5.B5.F.inv_std_fresh` | `layer5.block5.inv_std_fresh_sf` | `ctpt_attn_inv_std` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
...
| 281 | `L5.B5.W.wffn1` | `layer5.block5.wffn1_sf` | `ctpt_wffn1` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 282 | `L5.B5.M.gelu_coeff` | `layer5.block5.gelu_coeff_sf` | `ctpt_gelu_coeff` | `encoding` | **20** | `M` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 283 | `L5.B5.R.normalize_r` | `layer5.block5.normalize_rescale_sf` | `ctct_attn_normalize_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 287 | `L5.B5.K` | `layer5.block5.output_truncation_k` | `block5_output_truncation` | `truncation` | **13** | `K` | 3 | True | 16384 |  | `8,9,11,13,10,12` |  |
...
| 295 | `L6.B2.F.inv_std_fresh` | `layer6.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
| 296 | `L6.B2.F.x_centered_fresh` | `layer6.block2.x_centered_fresh_sf` | `ctpt_x_centered` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 297 | `L6.B2.M.gamma` | `layer6.block2.gamma_sf` | `ctpt_gamma` | `encoding` | **20** | `M` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 298 | `L6.B2.W.wk` | `layer6.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 299 | `L6.B2.W.wv` | `layer6.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 300 | `L6.B2.M.kt_mask1` | `layer6.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 301 | `L6.B2.M.kt_mask2` | `layer6.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 302 | `L6.B2.M.qkt_merge_mask` | `layer6.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 303 | `L6.B2.R.gamma_r` | `layer6.block2.gamma_rescale_sf` | `ctct_gamma_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 305 | `L6.B2.R.qkt_merge_mask_r` | `layer6.block2.qkt_merge_mask_rescale_sf` | `ctct_qkt_merge_mask_rescale` | `rescale` | **28** | `R` | 3 | True | 16384 | 28 | `None,24,26,28` |  |
...
| 314 | `L6.B4.F.softmax_out_fresh` | `layer6.block4.softmax_out_fresh_sf` | `ctpt_softmax_out` | `fresh` | **35** | `F` | 4 | True | 16384 | 35 | `27,29,31,33,35` |  |
| 315 | `L6.B4.F.v_fresh` | `layer6.block4.v_fresh_sf` | `ctpt_v` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 316 | `L6.B4.M.softmax_out_mask` | `layer6.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
...
| 319 | `L6.B4.S.ln_mean_inv_d` | `layer6.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 320 | `L6.B4.S.ln_var_inv_d` | `layer6.block4.ln_var_inv_d_sf` | `ctpt_inv_d_attn_var` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 321 | `L6.B4.W.wo` | `layer6.block4.wo_sf` | `ctpt_wo` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 322 | `L6.B4.R.softmax_v_matmul_r` | `layer6.block4.softmax_v_matmul_rescale_sf` | `ctct_softmax_v_matmul_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 343 | `L7.B2.F.inv_std_fresh` | `layer7.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
...
| 346 | `L7.B2.W.wk` | `layer7.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 347 | `L7.B2.W.wv` | `layer7.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 348 | `L7.B2.M.kt_mask1` | `layer7.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 349 | `L7.B2.M.kt_mask2` | `layer7.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 350 | `L7.B2.M.qkt_merge_mask` | `layer7.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 351 | `L7.B2.R.gamma_r` | `layer7.block2.gamma_rescale_sf` | `ctct_gamma_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 353 | `L7.B2.R.qkt_merge_mask_r` | `layer7.block2.qkt_merge_mask_rescale_sf` | `ctct_qkt_merge_mask_rescale` | `rescale` | **28** | `R` | 3 | True | 16384 | 28 | `None,24,26,28` |  |
...
| 362 | `L7.B4.F.softmax_out_fresh` | `layer7.block4.softmax_out_fresh_sf` | `ctpt_softmax_out` | `fresh` | **35** | `F` | 4 | True | 16384 | 35 | `27,29,31,33,35` |  |
| 363 | `L7.B4.F.v_fresh` | `layer7.block4.v_fresh_sf` | `ctpt_v` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
...
| 365 | `L7.B4.M.v_mask` | `layer7.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 366 | `L7.B4.M.softmax_v_mask` | `layer7.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 367 | `L7.B4.S.ln_mean_inv_d` | `layer7.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 368 | `L7.B4.S.ln_var_inv_d` | `layer7.block4.ln_var_inv_d_sf` | `ctpt_inv_d_attn_var` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 369 | `L7.B4.W.wo` | `layer7.block4.wo_sf` | `ctpt_wo` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 370 | `L7.B4.R.softmax_v_matmul_r` | `layer7.block4.softmax_v_matmul_rescale_sf` | `ctct_softmax_v_matmul_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 391 | `L8.B2.F.inv_std_fresh` | `layer8.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
| 392 | `L8.B2.F.x_centered_fresh` | `layer8.block2.x_centered_fresh_sf` | `ctpt_x_centered` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 393 | `L8.B2.M.gamma` | `layer8.block2.gamma_sf` | `ctpt_gamma` | `encoding` | **20** | `M` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 394 | `L8.B2.W.wk` | `layer8.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 395 | `L8.B2.W.wv` | `layer8.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 396 | `L8.B2.M.kt_mask1` | `layer8.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 397 | `L8.B2.M.kt_mask2` | `layer8.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 398 | `L8.B2.M.qkt_merge_mask` | `layer8.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 399 | `L8.B2.R.gamma_r` | `layer8.block2.gamma_rescale_sf` | `ctct_gamma_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 400 | `L8.B2.R.kt_mask2_r` | `layer8.block2.kt_mask2_rescale_sf` | `ctct_kt_mask2_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 410 | `L8.B4.F.softmax_out_fresh` | `layer8.block4.softmax_out_fresh_sf` | `ctpt_softmax_out` | `fresh` | **35** | `F` | 4 | True | 16384 | 35 | `27,29,31,33,35` |  |
| 411 | `L8.B4.F.v_fresh` | `layer8.block4.v_fresh_sf` | `ctpt_v` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 412 | `L8.B4.M.softmax_out_mask` | `layer8.block4.softmax_out_mask_sf` | `ctpt_softmax_out_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 413 | `L8.B4.M.v_mask` | `layer8.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 414 | `L8.B4.M.softmax_v_mask` | `layer8.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 415 | `L8.B4.S.ln_mean_inv_d` | `layer8.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 416 | `L8.B4.S.ln_var_inv_d` | `layer8.block4.ln_var_inv_d_sf` | `ctpt_inv_d_attn_var` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 417 | `L8.B4.W.wo` | `layer8.block4.wo_sf` | `ctpt_wo` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 418 | `L8.B4.R.softmax_v_matmul_r` | `layer8.block4.softmax_v_matmul_rescale_sf` | `ctct_softmax_v_matmul_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 419 | `L8.B4.R.ln_mean_r` | `layer8.block4.ln_mean_rescale_sf` | `ctct_attn_mean_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 420 | `L8.B4.R.ln_var_r` | `layer8.block4.ln_var_rescale_sf` | `ctct_attn_var_rescale` | `rescale` | **28** | `R` | 3 | True | 16384 | 28 | `None,24,26,28` |  |
...
| 439 | `L9.B2.F.inv_std_fresh` | `layer9.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
| 440 | `L9.B2.F.x_centered_fresh` | `layer9.block2.x_centered_fresh_sf` | `ctpt_x_centered` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 441 | `L9.B2.M.gamma` | `layer9.block2.gamma_sf` | `ctpt_gamma` | `encoding` | **20** | `M` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 442 | `L9.B2.W.wk` | `layer9.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 443 | `L9.B2.W.wv` | `layer9.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 444 | `L9.B2.M.kt_mask1` | `layer9.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 445 | `L9.B2.M.kt_mask2` | `layer9.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 446 | `L9.B2.M.qkt_merge_mask` | `layer9.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
...
| 458 | `L9.B4.F.softmax_out_fresh` | `layer9.block4.softmax_out_fresh_sf` | `ctpt_softmax_out` | `fresh` | **35** | `F` | 4 | True | 16384 | 35 | `27,29,31,33,35` |  |
| 459 | `L9.B4.F.v_fresh` | `layer9.block4.v_fresh_sf` | `ctpt_v` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
...
| 461 | `L9.B4.M.v_mask` | `layer9.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 462 | `L9.B4.M.softmax_v_mask` | `layer9.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 463 | `L9.B4.S.ln_mean_inv_d` | `layer9.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 464 | `L9.B4.S.ln_var_inv_d` | `layer9.block4.ln_var_inv_d_sf` | `ctpt_inv_d_attn_var` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 465 | `L9.B4.W.wo` | `layer9.block4.wo_sf` | `ctpt_wo` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 466 | `L9.B4.R.softmax_v_matmul_r` | `layer9.block4.softmax_v_matmul_rescale_sf` | `ctct_softmax_v_matmul_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 467 | `L9.B4.R.ln_mean_r` | `layer9.block4.ln_mean_rescale_sf` | `ctct_attn_mean_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 468 | `L9.B4.R.ln_var_r` | `layer9.block4.ln_var_rescale_sf` | `ctct_attn_var_rescale` | `rescale` | **28** | `R` | 3 | True | 16384 | 28 | `None,24,26,28` |  |
...
| 487 | `L10.B2.F.inv_std_fresh` | `layer10.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
| 488 | `L10.B2.F.x_centered_fresh` | `layer10.block2.x_centered_fresh_sf` | `ctpt_x_centered` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 489 | `L10.B2.M.gamma` | `layer10.block2.gamma_sf` | `ctpt_gamma` | `encoding` | **20** | `M` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 490 | `L10.B2.W.wk` | `layer10.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 491 | `L10.B2.W.wv` | `layer10.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 492 | `L10.B2.M.kt_mask1` | `layer10.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 493 | `L10.B2.M.kt_mask2` | `layer10.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 494 | `L10.B2.M.qkt_merge_mask` | `layer10.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
...
| 497 | `L10.B2.R.qkt_merge_mask_r` | `layer10.block2.qkt_merge_mask_rescale_sf` | `ctct_qkt_merge_mask_rescale` | `rescale` | **28** | `R` | 3 | True | 16384 | 28 | `None,24,26,28` |  |
| 498 | `L10.B2.K` | `layer10.block2.output_truncation_k` | `block2_output_truncation` | `truncation` | **10** | `K` | 4 | True | 16384 |  | `8,9,11,13,10,12` |  |
| 499 | `L10.B3.F.x_fresh` | `layer10.block3.x_fresh_sf` | `ctpt_softmax_x` | `fresh` | **28** | `F` | 4 | True | 16384 | 28 | `20,22,24,26,28` |  |
...
| 502 | `L10.B3.R.sq1` | `layer10.block3.square_rescale_sf_1` | `ctct_softmax_pow_s2` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 503 | `L10.B3.R.sq2` | `layer10.block3.square_rescale_sf_2` | `ctct_softmax_pow_s3` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 504 | `L10.B3.R.sq3` | `layer10.block3.square_rescale_sf_3` | `ctct_softmax_pow_s4` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 505 | `L10.B3.K` | `layer10.block3.output_truncation_k` | `block3_output_truncation` | `truncation` | **13** | `K` | 3 | True | 16384 |  | `8,9,11,13,10,12` |  |
| 506 | `L10.B4.F.softmax_out_fresh` | `layer10.block4.softmax_out_fresh_sf` | `ctpt_softmax_out` | `fresh` | **35** | `F` | 4 | True | 16384 | 35 | `27,29,31,33,35` |  |
| 507 | `L10.B4.F.v_fresh` | `layer10.block4.v_fresh_sf` | `ctpt_v` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
...
| 509 | `L10.B4.M.v_mask` | `layer10.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 510 | `L10.B4.M.softmax_v_mask` | `layer10.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 511 | `L10.B4.S.ln_mean_inv_d` | `layer10.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 512 | `L10.B4.S.ln_var_inv_d` | `layer10.block4.ln_var_inv_d_sf` | `ctpt_inv_d_attn_var` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 513 | `L10.B4.W.wo` | `layer10.block4.wo_sf` | `ctpt_wo` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 514 | `L10.B4.R.softmax_v_matmul_r` | `layer10.block4.softmax_v_matmul_rescale_sf` | `ctct_softmax_v_matmul_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 515 | `L10.B4.R.ln_mean_r` | `layer10.block4.ln_mean_rescale_sf` | `ctct_attn_mean_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
| 516 | `L10.B4.R.ln_var_r` | `layer10.block4.ln_var_rescale_sf` | `ctct_attn_var_rescale` | `rescale` | **28** | `R` | 3 | True | 16384 | 28 | `None,24,26,28` |  |
...
| 535 | `L11.B2.F.inv_std_fresh` | `layer11.block2.inv_std_fresh_sf` | `ctpt_inv_std` | `fresh` | **31** | `F` | 4 | True | 16384 | 31 | `23,25,27,29,31` |  |
| 536 | `L11.B2.F.x_centered_fresh` | `layer11.block2.x_centered_fresh_sf` | `ctpt_x_centered` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
| 537 | `L11.B2.M.gamma` | `layer11.block2.gamma_sf` | `ctpt_gamma` | `encoding` | **20** | `M` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 538 | `L11.B2.W.wk` | `layer11.block2.wk_sf` | `ctpt_wq_wk` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 539 | `L11.B2.W.wv` | `layer11.block2.wv_sf` | `ctpt_wv` | `encoding` | **22** | `W` | 4 | True | 16384 | 22 | `14,16,18,20,22` |  |
| 540 | `L11.B2.M.kt_mask1` | `layer11.block2.kt_mask1_sf` | `ctpt_rotKT_mask1` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 541 | `L11.B2.M.kt_mask2` | `layer11.block2.kt_mask2_sf` | `ctpt_rotKT_mask2` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 542 | `L11.B2.M.qkt_merge_mask` | `layer11.block2.qkt_merge_mask_sf` | `ctpt_mask` | `encoding` | **15** | `M` | 2 | True | 16384 | 15 | `11,13,15` |  |
| 543 | `L11.B2.R.gamma_r` | `layer11.block2.gamma_rescale_sf` | `ctct_gamma_rescale` | `rescale` | **31** | `R` | 3 | True | 16384 | 31 | `None,27,29,31` |  |
...
| 545 | `L11.B2.R.qkt_merge_mask_r` | `layer11.block2.qkt_merge_mask_rescale_sf` | `ctct_qkt_merge_mask_rescale` | `rescale` | **28** | `R` | 3 | True | 16384 | 28 | `None,24,26,28` |  |
...
| 554 | `L11.B4.F.softmax_out_fresh` | `layer11.block4.softmax_out_fresh_sf` | `ctpt_softmax_out` | `fresh` | **35** | `F` | 4 | True | 16384 | 35 | `27,29,31,33,35` |  |
| 555 | `L11.B4.F.v_fresh` | `layer11.block4.v_fresh_sf` | `ctpt_v` | `fresh` | **30** | `F` | 4 | True | 16384 | 30 | `22,24,26,28,30` |  |
...
| 557 | `L11.B4.M.v_mask` | `layer11.block4.v_mask_sf` | `ctpt_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 558 | `L11.B4.M.softmax_v_mask` | `layer11.block4.softmax_v_mask_sf` | `ctpt_softmax_v_mask` | `encoding` | **14** | `M` | 2 | True | 16384 | 14 | `10,12,14` |  |
| 559 | `L11.B4.S.ln_mean_inv_d` | `layer11.block4.ln_mean_inv_d_sf` | `ctpt_inv_d_attn_mean` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
| 560 | `L11.B4.S.ln_var_inv_d` | `layer11.block4.ln_var_inv_d_sf` | `ctpt_inv_d_attn_var` | `scalar` | **20** | `S` | 2 | True | 16384 | 20 | `16,18,20` |  |
...
| 564 | `L11.B4.R.ln_var_r` | `layer11.block4.ln_var_rescale_sf` | `ctct_attn_var_rescale` | `rescale` | **28** | `R` | 3 | True | 16384 | 28 | `None,24,26,28` |  |
...
> JSON 配对文件：`blb_stage2_baseline_action_full.json`。可以直接喂给 `Paean/run_final_eval.sh --action-config`。