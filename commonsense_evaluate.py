...
def parse_args():
    ...
    parser.add_argument('--dataset', choices=["boolq", "piqa", "social_i_qa", "hellaswag", "winogrande", "ARC-Challenge", "ARC-Easy", "openbookqa"],
                        required=True)
    parser.add_argument('--model', choices=['LLaMA-7B', 'LLaMA2-7B','LLaMA3-8B', "LLaMA-13B",'BLOOM-7B', 'GPT-j-6B'], required=True)
...
def load_model(args) -> tuple:
    ...
    if "LLaMA" in args.model and 'llama3' not in base_model:
