...
- **本次目标**：
  ...
  - 使用最新 GTrXL Stage-2 sequential policy、Pareto-only reward、non-monotonic empirical proposal sampler、guarded radius2。
  - 固定 `--stage2-k-trials 4` 和 `--stage2-probe-size 256`；四卡时每张卡跑一个独立噪声 trial。
